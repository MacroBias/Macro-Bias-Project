...
import { useAdminSession, useFrameworkSections } from "@/components/admin/admin-hooks";
import {
  inputClass,
  labelClass,
  panelClass,
  ...
  return (
    <div className="space-y-6">
      <div className={sectionHeaderClass}>
        <div>
          <h2 className="text-lg font-semibold text-white">Framework Page</h2>
          <p className="text-sm text-slate-400">
            Manage sections and copy for the Framework &amp; Methodology page.
          </p>
        </div>
        {lastUpdated ? (
      ...
      <div className={panelClass}>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Slugs become anchor IDs (e.g. &quot;what-is&quot;) and control the table of
          contents. Body supports markdown for paragraphs, lists, and tables.
        </p>
      ...
      <div className={panelClass}>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Edit or remove sections shown on the public Framework &amp; Methodology page.
        </p>
